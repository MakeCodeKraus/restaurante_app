...
class VisualizarMenu extends StatelessWidget {
  @override
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ChapterCard(
                        name: "Menú del día",
                        opcion: 1,
                        tag: "Núestro menú es actualizado día a día",
                        press: () {},
                      ),
                      ChapterCard(
                        name: "Ensaladas",
                        opcion: 2,
                        tag: "Para acompañar tu plato principal",
                        press: () {},
                      ),
                      ChapterCard(
                        name: "Postres",
                        opcion: 3,
                        tag: "No te quedes con el antojo",
                        press: () {},
                      ),
                      ChapterCard(
                        name: "Bebidas",
                        opcion: 4,
                        tag: "Contamos con gran variedad",
                        press: () {},
                      ),
                      SizedBox(height: 10),
                    ],
