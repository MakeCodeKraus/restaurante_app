            ...
            Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: AssetImage("assets/images/menuprincipal.jpg"),
                  ...
                  Padding(
                    ...
                    child: RichText(
                      text: TextSpan(
                        ...
                        children: [
                          TextSpan(text: "¿Qué deseas probar \nel dia de "),
                          TextSpan(
                              text: "hoy?",
                              style: TextStyle(
                      ...
                      children: <Widget>[
                        ...
                        RichText(
                          text: TextSpan(
                            style: Theme.of(context).textTheme.displaySmall,
                            children: [
                              TextSpan(text: "Contactanos para "),
                              TextSpan(
                                text: "domicilios y reservas",
                                style: TextStyle(fontWeight: FontWeight.bold),
                              ),
                            ],
                          ),
