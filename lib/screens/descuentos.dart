                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ChapterCard(
                        name: "Envío gratis",
                        opcion: 1,
                        tag: "Aplica solo en el área metropolitana",
                        press: () {},
                      ),
                      ChapterCard(
                        name: "Gana cupones de descuentos",
                        opcion: 2,
                        tag: "Apto para productos en especifico",
                        press: () {},
                      ),
                      ChapterCard(
                        name: "Combos para compartir",
                        opcion: 3,
                        tag: "Disfruta junto a familia y/o amigos",
                        press: () {},
                      ),
                      ChapterCard(
                        name: "Precios más asequibles",
                        opcion: 4,
                        tag: "¡Aprovechalos ya!, disponibles solo hasta las...",
                        press: () {},
                      ),
                      SizedBox(height: 10),
                    ],
